...
export class VisorHorarioComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const horarioG = new HorarioG('div#horario',this.Actividades);
  ...
  generarGraficoHorario(actividades: Actividad[], elementoDom: string) {
    ...
    //const horarioG: HorarioG = new HorarioG(actividades);
  ...
  //   const panelesActividad = aux.enter().append('g').panelesActividad.merge(aux);
